...
${OBJECTDIR}/_ext/56252444/cdc512.o: ../../src/cdc512.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -I. -Iinclude -I../../include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/56252444/cdc512.o ../../src/cdc512.cpp

${OBJECTDIR}/_ext/56252444/indexer.o: ../../src/indexer.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/56252444
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -I. -Iinclude -I../../include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/56252444/indexer.o ../../src/indexer.cpp

${OBJECTDIR}/_ext/56252444/main.o: ../../src/main.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/56252444
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -I. -Iinclude -I../../include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/56252444/main.o ../../src/main.cpp

${OBJECTDIR}/_ext/61759c81/cdc512.o: ../../tests/cdc512.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/61759c81
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -I. -Iinclude -I../../include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/61759c81/cdc512.o ../../tests/cdc512.cpp

${OBJECTDIR}/_ext/61759c81/indexer.o: ../../tests/indexer.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/61759c81
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -I. -Iinclude -I../../include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/61759c81/indexer.o ../../tests/indexer.cpp

${OBJECTDIR}/_ext/61759c81/locale_traits.o: ../../tests/locale_traits.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/61759c81
	${RM} "$@.d"
	$(COMPILE.cc) -g -Werror -I. -Iinclude -I../../include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/61759c81/locale_traits.o ../../tests/locale_traits.cpp
